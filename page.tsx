...
export default async function AdminGradesPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  return (
    <div style={{ display: 'flex', gap: 24, padding: '32px 24px', fontFamily: "'Vazirmatn', Tahoma, sans-serif", direction: 'rtl', maxWidth: 1200, margin: '0 auto' }}>
      {/*
        media query توی style های inline کار نمی‌کنه، و این پروژه فایل CSS سراسری
        برای پنل نداره — پس همین‌جا تزریق می‌شه.
        دسکتاپ (بالای ۹۰۰px): همه‌ی مشخصات فنی پرشده کامل نمایش داده می‌شن.
        موبایل/تبلت: فقط نشان «N مورد» با tooltip، چون جدول جا نمی‌شه.
      */}
      <style>{`

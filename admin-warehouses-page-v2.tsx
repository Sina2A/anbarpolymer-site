                      ...
                      >
                        ...
                        <div style={{ display: 'flex', gap: spacing.xs }}>
                          <form action={approveWarehouseDeletionAction} style={{ display: 'inline' }}>
                            ...
                            <button
                              type="submit"
                              style={{ ...btnDangerStyle, ...btnSmallStyle, background: colors.dangerText, color: '#fff', border: 'none' }}
                              onClick={(e) => !confirm(`انبار «${wh.name}» برای همیشه حذف بشه؟`) && e.preventDefault()}
                            >
                              تایید نهایی و حذف
                            </button>
                          </form>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: spacing.md, fontSize: fontSize.sm, color: colors.textMuted }}>
                          ...
                          {canEdit && !isPending && (
                            <form action={requestDeleteWarehouseAction} style={{ display: 'inline' }}>
                              ...
                              <button
                                type="submit"
                                style={{ ...btnDangerStyle, ...btnSmallStyle }}
                                onClick={(e) =>
                                  !confirm(
                                    isAdmin
                                      ? `انبار «${wh.name}» برای همیشه حذف بشه؟`
                                      : `درخواست حذف انبار «${wh.name}» برای مدیر ارسال بشه؟`
                                  ) && e.preventDefault()
                                }
                              >
